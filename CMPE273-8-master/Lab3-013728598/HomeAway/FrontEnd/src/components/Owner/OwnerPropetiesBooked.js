...
import { OwnerBooked } from '../../queries/queries';
 ...
 class OwnerPropertysBooked extends Component
{
    ...
    componentWillMount(){
        ...
        this.props.client.query({
            ...
            this.setState({
                properties:this.state.properties.concat(res.data.OwnerBooked)
            })
        });
    ...
    render()
    {
        ...
        export default compose(
            graphql(OwnerBooked, { name: "OwnerBooked" }),
           
            )
            (withApollo(OwnerPropertysBooked))
